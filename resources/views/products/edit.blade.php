        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('products.data') }}" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Ebook</a>
                    </div>
                </div>
            </nav>
        </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Edit Ebook</h6>
                        <a href="{{ route('products.data') }}">Kembali</a>
                    </div>
                    <div class="container">
                        <form method="POST" action="{{ route('products.update', $ebook->id_ebook) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                <label for="sampul_ebook">Sampul Ebook:</label>
                                <input type="file" id="sampul_ebook" name="sampul_ebook" value="{{ $ebook->sampul_ebook }}" required>
                            </div>

                            <div class="form-group">
                                <label for="file_ebook">File Ebook:</label>
                                <input type="file" id="file_ebook" name="file_ebook" value="{{ $ebook->file_ebook }}" required>
                            </div>
